...
public class AlphabeticalComparatorTest {
    ...
    public void childrenInHomeDirectoryComparatorTest() {
        ...
        String[] actual = apfsEleToString(rootDir.findDirectoryByName("home").getChildren(
                (ApfsElement apfsEle1, ApfsElement apfsEle2)
                        -> apfsEle1.getName().compareToIgnoreCase(apfsEle2.getName())
        ));
    ...
    public void filesInCodeDirectoryComparatorTest() {
        ...
        ApfsDirectory rootDir = (ApfsDirectory) apfs.getRoot();
        String[] actual = filesToString(rootDir.findDirectoryByName("home").findDirectoryByName("code").getFiles((ApfsElement apfsEle1, ApfsElement apfsEle2) -> apfsEle1.getName().compareToIgnoreCase(apfsEle2.getName())));
    ...
    public void filesInApplicationDirectoryComparatorTest() {
        ...
        ApfsDirectory rootDir = (ApfsDirectory) apfs.getRoot();
        String[] actual = filesToString(rootDir.findDirectoryByName("applications").getFiles((ApfsElement apfsEle1, ApfsElement apfsEle2) -> apfsEle1.getName().compareToIgnoreCase(apfsEle2.getName())));
    ...
    public void childrenInCodeDirectoryComparatorTest() {
        ...
        ApfsDirectory rootDir = (ApfsDirectory) apfs.getRoot();
        String[] actual = apfsEleToString(rootDir.findDirectoryByName("home").findDirectoryByName("code").getChildren((ApfsElement apfsEle1, ApfsElement apfsEle2) -> apfsEle1.getName().compareToIgnoreCase(apfsEle2.getName())));
    ...
    public void directoriesInRootDirectoryComparatorTest() {
        ...
        ApfsDirectory rootDir = (ApfsDirectory) apfs.getRoot();
        String[] actual = dirsToString(rootDir.getSubDirectories((ApfsElement apfsEle1, ApfsElement apfsEle2) -> apfsEle1.getName().compareToIgnoreCase(apfsEle2.getName())));
    ...
    public void directoriesInHomeDirectoryComparatorTest() {
        ...
        ApfsDirectory rootDir = (ApfsDirectory) apfs.getRoot();
        String[] actual = dirsToString(rootDir.findDirectoryByName("home").getSubDirectories((ApfsElement apfsEle1, ApfsElement apfsEle2) -> apfsEle1.getName().compareToIgnoreCase(apfsEle2.getName())));
