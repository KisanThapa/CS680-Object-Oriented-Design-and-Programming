...
public class ApfsDirectory extends ApfsElement {
    ...
    public LinkedList<ApfsElement> getChildren() {
        Collections.sort(this.children, (ApfsElement apfsEle1, ApfsElement apfsEle2)
    ...
    public LinkedList<ApfsDirectory> getSubDirectories() {
        ...
        Collections.sort(subDir, (ApfsElement apfsEle1, ApfsElement apfsEle2)
                -> apfsEle1.getName().compareToIgnoreCase(apfsEle2.getName()));
        return subDir;
    }
    ...
    public LinkedList<ApfsFile> getFiles() {
        ...
        Collections.sort(files, (ApfsElement apfsEle1, ApfsElement apfsEle2)
                -> apfsEle1.getName().compareToIgnoreCase(apfsEle2.getName()));
        return files;
    }
