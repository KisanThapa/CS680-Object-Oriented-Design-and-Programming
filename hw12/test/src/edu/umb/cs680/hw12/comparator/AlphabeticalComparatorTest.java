...
public class AlphabeticalComparatorTest {
    ...
    public void childrensInHomeDiretoryComparatorTest() {
        ...
        String[] actual = apfsEleToString(
                rootDir.findDirectoryByName("home").getChildren(new AlphabeticalComparator()));
    ...
    public void filesInCodeDiretoryComparatorTest() {
        ...
        String[] actual = filesToString(
                rootDir.findDirectoryByName("home").findDirectoryByName("code").getFiles(new AlphabeticalComparator()));
    ...
    public void filesInApplicationDiretoryComparatorTest() {
        ...
        ApfsDirectory rootDir = (ApfsDirectory) apfs.getRoot();
        String[] actual = filesToString(
                rootDir.findDirectoryByName("applications").getFiles(new AlphabeticalComparator()));
    ...
    public void childrensInCodeDiretoryComparatorTest() {
        ...
        ApfsDirectory rootDir = (ApfsDirectory) apfs.getRoot();
        String[] actual = apfsEleToString(
                rootDir.findDirectoryByName("home").findDirectoryByName("code").getChildren(new AlphabeticalComparator()));
    ...
    public void directoriesInRootDiretoryComparatorTest() {
        ...
        String[] actual = dirsToString(
                rootDir.getSubDirectories(new AlphabeticalComparator()));
    ...
    public void directoriesInHomeDiretoryComparatorTest() {
        ...
        ApfsDirectory rootDir = (ApfsDirectory) apfs.getRoot();
        String[] actual = dirsToString(
                rootDir.findDirectoryByName("home").getSubDirectories(new AlphabeticalComparator()));
