...
import edu.umb.cs680.hw12.apfs.comparator.ReverseAlphabeticalComparator;
...
public class ReverseAlphabeticalComparatorTest {
    ...
    public void childrensInHomeDiretoryComparatorTest() {
        ...
        String[] actual = apfsEleToString(
                rootDir.findDirectoryByName("home").getChildren(new ReverseAlphabeticalComparator()));
    ...
    public void filesInCodeDiretoryComparatorTest() {
        ...
        String[] actual = filesToString(
                rootDir.findDirectoryByName("home").findDirectoryByName("code")
                        .getFiles(new ReverseAlphabeticalComparator()));
    ...
    public void filesInApplicationDiretoryComparatorTest() {
        ...
        ApfsDirectory rootDir = (ApfsDirectory) apfs.getRoot();
        String[] actual = filesToString(
                rootDir.findDirectoryByName("applications").getFiles(new ReverseAlphabeticalComparator()));
    ...
    public void directoriesInRootDiretoryComparatorTest() {
        ...
        String[] actual = dirsToString(
                rootDir.getSubDirectories(new ReverseAlphabeticalComparator()));
    ...
    public void directoriesInHomeDiretoryComparatorTest() {
        ...
        ApfsDirectory rootDir = (ApfsDirectory) apfs.getRoot();
        String[] actual = dirsToString(
                rootDir.findDirectoryByName("home").getSubDirectories(new ReverseAlphabeticalComparator()));
